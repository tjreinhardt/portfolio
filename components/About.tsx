  ...
  return (
    <motion.div
      ...
      <motion.img
        ...
        className='-mb-20 md:mb-0 flex-shrink-0 w-40 h-40 mt-[140px] rounded-full object-cover md:rounded-lg md:w-64 md:h-96 xl:w-[500px] xl:h-[600px]'
      />

      <div className='space-y-5 md:space-y-5 px-0 md:px-10 mt-20'>
        ...
        <p className=' text-sm md:text-lg pb-14'>
